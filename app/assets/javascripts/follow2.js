...
(function(MM) {
    ...
    MM.Follower = function(map, location, content) {
        ...
        ctx.transform(1, 0, -0.5, 0.5, 25, this.dimensions.y/2);
    ...
    MM.Follower.prototype = {
        ...
        drawBubblePath: function(ctx) {
            ctx.beginPath();
            ctx.moveTo(42, this.dimensions.y -15);
            ctx.lineTo(50, this.dimensions.y-25);
            ctx.lineTo(this.dimensions.x-5, this.dimensions.y-25);
            ctx.quadraticCurveTo(this.dimensions.x, this.dimensions.y-25, this.dimensions.x, this.dimensions.y-30);
            ctx.lineTo(this.dimensions.x, 5);
            ctx.quadraticCurveTo(this.dimensions.x, 0, this.dimensions.x-3, 0);
            ctx.lineTo(5, 0);
            ctx.quadraticCurveTo(0, 0, 0, 10);
            ctx.lineTo(0, this.dimensions.y-35);
            ctx.quadraticCurveTo(0, this.dimensions.y-23, 5, this.dimensions.y-25);
            ctx.lineTo(34, this.dimensions.y-24);
            ctx.moveTo(15, this.dimensions.y);
        }
